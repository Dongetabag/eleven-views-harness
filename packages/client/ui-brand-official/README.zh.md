...
本包会在每个 Web 构建中使用 Eleven Views 品牌填充 `sidebar.brand.mark`、`sidebar.brand.name` 和 `conversation.hero.brand.mark`。
...
- **本包只提供一组 Eleven Views occupant** —— 其他呈现应由占用相同 slot 的另一个 Cordis 包提供。
