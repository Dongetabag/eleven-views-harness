...
This package fills `sidebar.brand.mark`, `sidebar.brand.name`, and `conversation.hero.brand.mark` with the Eleven Views identity in every Web build.
...
- **The package supplies one Eleven Views occupant set** — alternative presentation belongs in another Cordis package occupying the same slots.
